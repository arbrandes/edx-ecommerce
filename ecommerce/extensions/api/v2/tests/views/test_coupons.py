...
from ecommerce.extensions.api.v2.views.coupons import CouponOrderCreateViewSet
...
class CouponOrderCreateViewSetTest(TestCase):
    ...
    def setUp(self):
        super(CouponOrderCreateViewSetTest, self).setUp()
    ...
    def test_create(self):
        ...
        response = CouponOrderCreateViewSet().create(request)
    ...
    def test_append_to_existing_coupon(self):
        ...
        coupon_append = CouponOrderCreateViewSet().create_coupon_product(
            title='Test coupon',
            price=100,
            data=data
        )
    ...
    def test_custom_code_string(self):
        ...
        custom_coupon = CouponOrderCreateViewSet().create_coupon_product(
            title='Custom coupon',
            price=100,
            data=data
        )
    ...
    def test_custom_code_integrity_error(self):
        ...
        CouponOrderCreateViewSet().create_coupon_product(
            title='Custom coupon',
            price=100,
            data=data
        )
    ...
    def test_add_product_to_basket(self):
        ...
        basket = CouponOrderCreateViewSet().add_product_to_basket(
            product=coupon,
    ...
    def test_create_order(self):
        ...
        response_data = CouponOrderCreateViewSet().create_order_for_invoice(basket, coupon_id=coupon.id)
...
class CouponOrderCreateViewSetFunctionalTest(TestCase):
    """Test the coupon order creation functionality."""

    def setUp(self):
        super(CouponOrderCreateViewSetFunctionalTest, self).setUp()
        self.user = self.create_user(is_staff=True)
        self.client.login(username=self.user.username, password=self.password)
