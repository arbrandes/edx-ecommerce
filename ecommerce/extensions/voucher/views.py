...
class CouponReportView(View):
    ...
    def get(self, request, coupon_id=None):
        ...
        If no coupon was sent, coupon report will be generated for all created vouchers.
        """

        filename = "Coupon Report for"
        ...
        for coupon_voucher in coupons_vouchers:
            for voucher in coupon_voucher.vouchers.all():
                ...
                voucher.URL = '{}/coupons/offer/?code={}'.format(settings.ECOMMERCE_URL_ROOT, voucher.code)
